...
VL_INLINE_OPT void Vmycpu_top_icache_tag___sequent__TOP__mycpu_top__inst_cache__icache_tag_1__1(Vmycpu_top_icache_tag* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_icache_tag___sequent__TOP__mycpu_top__inst_cache__icache_tag_1__1\n"); );
    // Body
