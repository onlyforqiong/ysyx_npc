...
#ifndef VERILATED_VMYCPU_TOP_DATA_RAM_ONE_PORT_H_
#define VERILATED_VMYCPU_TOP_DATA_RAM_ONE_PORT_H_  // guard
...
class Vmycpu_top_data_ram_one_port final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vmycpu_top_data_ram_one_port(Vmycpu_top__Syms* symsp, const char* name);
    ~Vmycpu_top_data_ram_one_port();
    VL_UNCOPYABLE(Vmycpu_top_data_ram_one_port);
