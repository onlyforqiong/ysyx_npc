...
VL_INLINE_OPT void Vmycpu_top_mycpu_top___combo__TOP__mycpu_top__3(Vmycpu_top_mycpu_top* vlSelf) {
    ...
    vlSelf->__PVT__data_cache_io_sram_size = vlSelf->__PVT__u_riscv_cpu_data_size;
...
VL_INLINE_OPT void Vmycpu_top_mycpu_top___combo__TOP__mycpu_top__11(Vmycpu_top_mycpu_top* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vmycpu_top_mycpu_top___combo__TOP__mycpu_top__11\n"); );
    // Body
...
VL_INLINE_OPT void Vmycpu_top_mycpu_top___combo__TOP__mycpu_top__12(Vmycpu_top_mycpu_top* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vmycpu_top_mycpu_top___combo__TOP__mycpu_top__12\n"); );
    // Body
