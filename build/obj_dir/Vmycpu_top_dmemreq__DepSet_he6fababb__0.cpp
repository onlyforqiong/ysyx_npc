...
VL_INLINE_OPT void Vmycpu_top_dmemreq___combo__TOP__mycpu_top__u_riscv_cpu___dmemreq__0(Vmycpu_top_dmemreq* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_dmemreq___combo__TOP__mycpu_top__u_riscv_cpu___dmemreq__0\n"); );
    // Body
...
VL_INLINE_OPT void Vmycpu_top_dmemreq___combo__TOP__mycpu_top__u_riscv_cpu___dmemreq__1(Vmycpu_top_dmemreq* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_dmemreq___combo__TOP__mycpu_top__u_riscv_cpu___dmemreq__1\n"); );
    // Body
...
VL_INLINE_OPT void Vmycpu_top_dmemreq___combo__TOP__mycpu_top__u_riscv_cpu___dmemreq__2(Vmycpu_top_dmemreq* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_dmemreq___combo__TOP__mycpu_top__u_riscv_cpu___dmemreq__2\n"); );
    // Body
...
VL_INLINE_OPT void Vmycpu_top_dmemreq___combo__TOP__mycpu_top__u_riscv_cpu___dmemreq__3(Vmycpu_top_dmemreq* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_dmemreq___combo__TOP__mycpu_top__u_riscv_cpu___dmemreq__3\n"); );
    // Body
