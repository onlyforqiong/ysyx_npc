...
class Vmycpu_top_mycpu_top final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        VL_OUT8(axi_mem_port_0_wstrb,3,0);
        ...
        VL_OUT8(axi_mem_port_1_wstrb,3,0);
    ...
    struct {
        ...
        CData/*3:0*/ __PVT__data_cache_io_port_wstrb;
        ...
        CData/*3:0*/ __PVT__data_cache_io_data_wstrb;
